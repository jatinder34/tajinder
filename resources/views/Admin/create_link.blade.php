		    	...
		    	<div class="col-lg-12 col-md-12">
		    	  ...
		    	  <div class="card card-small mb-3">
	    	    	...
	    	    	<div class="card-body">
	    	    		...
	    	    		<select id="isp" data-placeholder="Begin typing a name to ISP..." name="isp[]" class="chosen-select form-control form-control-lg mb-3" multiple="multiple">
		    	            @if(!$isp->isEmpty())
		    	          	    @foreach($isp as $ispp)
	    	    	...
	    	    	<div class="card-body">
	    	    		...
	    	    		<select class="chosen-select form-control form-control-lg mb-3" id="browser" name="browser[]" multiple="multiple">
	    	    	...
	    	    	<div class="card-body">
	    	    		...
	    	    		<select class=" chosen-select form-control form-control-lg mb-3" id="os" name="os[]" multiple="multiple" >
	    	    	...
	    	    	<div class="card-body">
	    	    		...
	    	    		<select class=" chosen-select form-control form-control-lg mb-3" id="devicetype" name="devicetype[]" multiple="multiple" >
	    	    	...
	    	    	<div class="card-body">
	    	    		...
	    	    		<select class=" chosen-select form-control form-control-lg mb-3" id="country" name="country" multiple="multiple" >
